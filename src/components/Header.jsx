...
const Header = ({
  ...
  return (
    <div>
      ...
      <h1 className=" text-center font-extrabold text-5xl text-green-500 pt-[0.5em]">
        CART ITEMS
      </h1>
      <div className="flex justify-evenly items-center pt-[1em]">
        <button
      ...
      <div className="flex text-center justify-evenly pt-[3em]">
